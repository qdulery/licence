...
setcookie("cat");
if( isset($_COOKIE['categorie']['cat']) && $_COOKIE['categorie']['cat']!="all"){
    $numCat=$_COOKIE['categorie']['cat'];
    echo $numCat;
    $requete = "SELECT * FROM article WHERE id_categorie=$numCat ORDER BY RAND() LIMIT 3";   
}else{
